...
export default function TextoTour() {
  return (
    <div id="tour">
      ...
      <p>No vamos a recorrer los puntos “de interés” ni iremos a los lugares más visitados. 
      No te recomendaremos los mejores sitios para visitar. 
      Pero sí los que deberías. </p>
